...
This version will create a web based chat app. You can then integrate this with other services, like Twilio for SMS and Facebook Messenger, through Smooch. Cool stuff!
